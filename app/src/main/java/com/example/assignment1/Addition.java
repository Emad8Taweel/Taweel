...
public class Addition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int randomNumber2 = ThreadLocalRandom.current().nextInt(20);
        int randomNumber3 = ThreadLocalRandom.current().nextInt(20);
        int randomNumber4 = ThreadLocalRandom.current().nextInt(20);


        tx_number1.setText(String.valueOf(randomNumber1));
        tx_number2.setText(String.valueOf(randomNumber2));
        tx_2number1.setText(String.valueOf(randomNumber3));
        tx_2number2.setText(String.valueOf(randomNumber4));
        ...
        int correctAnswer2 = randomNumber3+randomNumber4;
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Addition.this, OperationSelectionActivity.class);
                ...
                try {
                    ...
                    if (userAnswer1 == correctAnswer1 && userAnswer2 == correctAnswer2) {
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intent = new Intent(Addition.this, Addition.class);
                                startActivity(intent);
                                finish();
                            }
                        }, 2000);
